...
/***************************************************************************
 SelecionaBNGB
                                 A QGIS plugin
 Dá zoom para uma feição selecionada na tabela t_interface
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2019-01-29
        git sha              : $Format:%H$
        copyright            : (C) 2019 by Marcel Emanuelli Rotunno/IBGE
...
from .selecionaBNGB_dialog import SelecionaBNGBDialog
import os.path

# Import other modules
from qgis.core import QgsProject, QgsDataSourceUri, QgsFeatureRequest, QgsCoordinateTransform
...
class SelecionaBNGB:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&selecionaBNGB3')
    ...
    def run(self):
        ...
        camadaAtiva = QgsProject.instance().mapLayersByName('t_interface')[0]
        ...
        uri.setKeyColumn('id')
        # print('URI feição t_interface = ', uri.uri())
        ...
        nova_selecao = camada_adicionada.getFeatures(QgsFeatureRequest().setFilterExpression(u'"id" = ' + str(selecao[0]['id_objeto_producao'])))
        # print("nova selecao = ", nova_selecao)
        camada_adicionada.selectByIds([feicao.id() for feicao in nova_selecao])            
        ...
        # Sistema de coordenadas da camada
        ...
        srsTransform = QgsCoordinateTransform(camadaSrs, mapCanvasSrs, QgsProject.instance())
